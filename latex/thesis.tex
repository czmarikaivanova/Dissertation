...
%
\title{
{\fontsize{28}{30}\usefont{OT1}{phv}{bc}{n}\selectfont Optimization Problems with Communication}
	\author{
...
% Main chapters
%
\include{chap1-background}         % Introduction
\include{chap2-adhoc}         % Introduction
\include{chap3-mbt}         % Introduction
\include{chap4-mpf}         % Introduction
%
